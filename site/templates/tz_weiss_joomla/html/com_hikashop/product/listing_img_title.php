...
<?php if (!$this -> module && $this->config->get('show_quantity_field')<2) { ?>
...
<div style="text-align:center;clear:both;" class="hikashop_product_image">
	<div style="position:relative;text-align:center;clear:both;margin: auto;" class="hikashop_product_image_subdiv">
        <?php if(!$this->module):?>
        <span class="bg_over">
            <a href="<?php echo $link;?>" class="btn-view" title="<?php echo $this->escape($this->row->product_name); ?>">
                <span class="fa fa-search"></span>
            </a>
            <?php
            if($this->params->get('add_to_cart') || $this->params->get('add_to_wishlist')){
                $this->setLayout('add_to_cart_listing_custom');
...
$this->setLayout('listing_custom_field');
echo $this->loadTemplate();
