...
if (empty ($this->element)) {
	...
	?>
    <?php if($this->productlayout != 'show_default'){ ?>
	...
	?>
	<?php if($this->productlayout != 'show_tabular' && $this->productlayout != 'show_default'){ ?>
	...
	if($this->productlayout != 'show_tabular' && $this->productlayout != 'show_default'){
