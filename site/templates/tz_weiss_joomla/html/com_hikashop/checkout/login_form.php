...
<!--				<span class="add-on">-->
					<i class="fa fa-user tip" title="<?php echo JText::_('HIKA_USERNAME'); ?>"></i>
...
<!--				</span>-->
				...
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind');?>" class="hasTooltip" title="<?php echo JText::_('HIKA_FORGOT_YOUR_USERNAME'); ?>">
	...
	<div id="form-login-password" class="control-group">
		<div class="controls">
			<div class="input-prepend input-append">
<!--				<span class="add-on">-->
					<i class="fa fa-unlock-alt tip" title="<?php echo JText::_('HIKA_PASSWORD') ?>"></i>
...
<!--				</span>-->
				...
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=reset');?>" class="hasTooltip" title="<?php echo JText::_('HIKA_FORGOT_YOUR_PASSWORD'); ?>">
                    <i class="fa fa-question-circle"></i>
                </a>
			</div>
		</div>
