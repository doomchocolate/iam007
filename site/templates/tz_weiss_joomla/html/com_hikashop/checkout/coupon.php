...
?><span class="hikashop_checkout_coupon" id="hikashop_checkout_coupon">
	...
	<?php
		echo $this->cart->displayButton(JText::_('ADD'),'refresh',$this->params,hikashop_completeLink('checkout'),'',' onclick="return hikashopCheckCoupon(\'hikashop_checkout_coupon_input\');"',0,1,'btn');
    ?>
<!--    <a href="hikashop_completeLink('checkout')"-->
<!--       onclick="return hikashopCheckCoupon('hikashop_checkout_coupon_input');" class="btn">--><?php //echo JText::_('ADD')?><!--</a>-->
    <?php
	}else{
