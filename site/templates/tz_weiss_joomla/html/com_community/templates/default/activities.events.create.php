...
<div class="joms-stream-content">
    ...
    <header>
        <!-- Author name -->
        <a href="<?php echo CUrlHelper::userLink($user->id); ?>" data-joms-username class="joms-share-user"><strong><?php echo $user->getDisplayName(); ?></strong></a> <?php echo JText::_('COM_COMMUNITY_EVENTS_ACTIVITIES_NEW_EVENT'); ?>
        <!-- Privacy -->
        <div>
