...
<?php foreach ($list as $i => $item) :
    $media = $item -> media;
?>
    <li class="media<?php if($i == 0) echo ' first'; if($i == count($list)-1 ) echo ' last'?>">
    <?php if(!$media OR ($media AND $media -> type != 'quote' AND $media -> type != 'link')):?>
        <?php if($params -> get('show_article',1)):?>
            ...
            <?php if($params -> get('show_title',1) OR $params -> get('show_created_date',0) OR $params -> get('show_introtext',1)):?>
