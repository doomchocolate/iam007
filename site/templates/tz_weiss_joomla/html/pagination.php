        ...
        if(!$page['active']){
            if(version_compare(JVERSION,'3.0','ge')){
                if(preg_match('#<li.*?class=".*?disable.*?".*?>#', $page['data'],$match)){
                    $page['data']   = preg_replace('#(<li.*?class=".*?)(disable)(.*?".*?>.*?</li>)#','$1disabled$3',$page['data']);
                }
                ...
                if(preg_match('#<li.*?class=".*?actived.*?".*?>#', $page['data'],$match)){
                    ...
                    if(preg_match('#(<li.*?class=")(.*?)(".*?>)#', $page['data'],$match)){
                        $page['data']   = preg_replace('#(<li.*?class=")(.*?)(".*?>)#','$1active$3',$page['data']);
                    }else{
