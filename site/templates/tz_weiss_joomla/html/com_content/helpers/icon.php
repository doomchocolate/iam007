...
abstract class JHtmlIcon
{
	...
	public static function email($article, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			...
			{
				$text = '<span class="fa fa-envelope-o"></span> ' . JText::_('JGLOBAL_EMAIL');
			}
		}
		else
		{
	...
	public static function edit($article, $params, $attribs = array(), $legacy = false)
	{
		...
		else
		{
			...
			$text = '<span class="hasTooltip fa fa-' . $icon . ' tip" title="' . JHtml::tooltipText(JText::_('COM_CONTENT_EDIT_ITEM'), $overlib, 0) . '"></span>&#160;' . JText::_('JGLOBAL_EDIT') . '&#160;';
		}
