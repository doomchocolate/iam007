...
<?php if ($params->get('show_print_icon') || $params->get('show_email_icon') || $canEdit) : ?>
    <div class="TzIcons icons">
        <div class="btn-group pull-right"> <a class="btn dropdown-toggle" data-toggle="dropdown" role="button"> <span class="icon-cog"></span> <span class="caret"></span> </a>
