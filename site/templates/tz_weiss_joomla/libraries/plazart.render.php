...
//        }
        ...
        $c_version = $version -> RELEASE;
        $check_version = substr($c_version,0,1);
//        if($check_version == 2) {
            if(file_exists(PLAZART_TEMPLATE_PATH.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'message_j25.php')){
                require (PLAZART_TEMPLATE_PATH.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'message_j25.php');
            }
//        }
