...
class CommunityRegisterController extends CommunityBaseController
{
    ...
    public function activate(){
        ...
        if ($useractivation == 0){
            $mainframe->redirect('index.php?option=com_users&view=login', JText::_('COM_COMMUNITY_REGISTRATION_ACTIVATE_SUCCESS') ,"message");
        }elseif ($useractivation == 1){
            $mainframe->redirect('index.php?option=com_users&view=registration&layout=complete&view=login', JText::_('COM_COMMUNITY_REGISTRATION_ADMINACTIVATE_SUCCESS') ,"message");
        }
