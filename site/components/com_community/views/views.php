...
class CommunityView extends JViewLegacy {
    ...
    public function showHeader($title, $icon = null, $buttons = null) {
        ...
        $view = $jinput->get('view', 'frontpage', 'STRING');
    ...
    public function attachHeaders() {
        ...
        $js = 'assets/bootstrap/bootstrap.override.js';
        CAssets::attach($js, 'js');
        ...
        // Load jQuery textntags plugin
        // $css = 'assets/jquery-textntags/jquery-textntags.css';
        // CAssets::attach($css, 'css');
