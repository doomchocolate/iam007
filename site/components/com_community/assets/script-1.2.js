...
joms.extend({
    ...
    activities: {
        ...
        init: function() {
            ...
            joms.jQuery('li[data-streamid] [data-action="delete"]').on('click', this, function(e) {
                e.preventDefault();
            ...
            if(joms.activities.infiniteScrollLoaded == 0 && joms.activities.infinitesScrollenable == 1){
        ...
        prependOldStream: function(html)
        {
            ...
            joms.jQuery( html ).children('li').appendTo('#activity-stream-container > ul.list-unstyled');
        ...
        infiniteScroll: function(){
            joms.jQuery(window).scroll(function()
            {
                if(joms.jQuery(window).scrollTop() == joms.jQuery(document).height() - joms.jQuery(window).height())
                {
    ...
    miniwall: {
        initialize: function() {
            ...
            joms.jQuery('a[href="#showallcomments"]').live('click', function() {
                var streamid = joms.jQuery(this).parents('li').data('streamid');
