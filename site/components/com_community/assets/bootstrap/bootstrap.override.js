...
!function($){
  ...
  * ================================= */
  ...
  , hide: function () {
      this.$menuWrapper && this.$menuWrapper.hide()
      this.$menu.hide()
      this.shown = false
      return this
    }
  ...
  , scrollIntoView: function() {
      var active = this.$menu.find('.active')
        , acheight = active.height()
        , acpos = active.position()
        , parent = this.$menu
        , paheight = parent.height()
        , pascroll = parent.scrollTop()
        , papadding = 0
        , first
      ...
      if (acpos.top < pascroll + papadding) {
        parent.scrollTop(acpos.top)
      } else if (acpos.top + acheight > pascroll + paheight) {
        parent.scrollTop(acpos.top + acheight)
      }
  }
