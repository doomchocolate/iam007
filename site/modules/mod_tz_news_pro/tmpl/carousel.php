...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('.tz-carousel').find('.module-title')
            .css({
                'width': jQuery('.tz-carousel').height(),
                'transform': 'rotate(270deg) translate(-'+(
                    (jQuery('.tz-carousel').height()/2  - Math.ceil(jQuery('.tz-carousel').find('.module-title span').outerHeight()/2)))
                    +'px,-' + (jQuery('.tz-carousel').height()/2 +jQuery('.tz-carousel').find('.module-title span').outerHeight()
                    -jQuery('.tz-carousel').find('.module-title span').outerHeight()/2)+'px)'
            });
