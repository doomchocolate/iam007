...
class JFormFieldTzStatistic extends JFormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!version_compare(JVERSION,'3.0','ge')) {
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_statistic/admin/js/jquery-1.9.1.min.js');
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_statistic/admin/js/jquery-noconflict.js');
        }
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_statistic/admin/js/base64.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_statistic/admin/js/jquery-ui-min.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_statistic/admin/js/tzstatistic.js');
        ...
        window.addEvent("domready",function(){
            ...
            languages.langQuestion    = "'.JText::_('MOD_TZ_STATISTIC_DELETE_QUESTION').'";
            tzstatistic("'.$this -> tzid.'","'.$this -> element['name'].'","'.$element['name'].'","'
        ...
        if (!$childRequired) {
            $html[] = '           <th>' . JText::_('MOD_TZ_STATISTIC_INFORMATION') . '</th>';
        }
        ...
        $html[] = '<button class="btn" type="button" id="' . $this->prefix . 'button_cancel">' .
            '<i title="' . JText::_('JCANCEL') . '" class="icon-cancel"></i> ' . JText::_('MOD_TZ_STATISTIC_RESET') . '</button>';
        $html[] = ' </div>';
