...
class JFormFieldTZClient extends JFormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!version_compare(JVERSION, '3.0', 'ge')) {
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_client/admin/js/jquery-1.9.1.min.js');
            $doc->addScript(JUri::root(true) . '/modules/mod_tz_client/admin/js/jquery-noconflict.js');
        }
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_client/admin/js/base64.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_client/admin/js/jquery-ui-min.js');
        $doc->addScript(JUri::root(true) . '/modules/mod_tz_client/admin/js/tzclient.js');
        ...
        window.addEvent("domready",function(){
            ...
            languages.langQuestion    = "' . JText::_('MOD_TZ_CLIENT_DELETE_QUESTION') . '";
        ...
        $html[] = '<button class="btn" type="button" id="' . $this->prefix . 'button_cancel">' .
            '<i title="' . JText::_('JCANCEL') . '" class="icon-cancel"></i> ' . JText::_('MOD_TZ_CLIENT_RESET') . '</button>';
        $html[] = ' </div>';
...
//        $html[] = '     <div id="drag">';
        ...
        if (!$childRequired) {
            $html[] = '           <th>' . JText::_('MOD_TZ_CLIENT_INFORMATION') . '</th>';
        }
