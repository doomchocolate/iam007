	...
	class RevSliderOutput{
						...
						case "video":
							...
							switch($videoType){
								case "youtube":
									...
									$html = "<iframe src='".$setBase."www.youtube.com/embed/".$videoID."?enablejsapi=1&amp;html5=1&amp;".$videoArgs."' width='".$videoWidth."' height='".$videoHeight."' style='width:".$videoWidth."px;height:".$videoHeight."px;'></iframe>";
								break;
								case "vimeo":
									if(empty($videoArgs))
		...
		private function putJS(){
	 	  ...
	 	  //modify navigation type (backward compatability)
			...
			$videoJsPath = GlobalsRevSlider::$url_item_plugin."/videojs/";				
