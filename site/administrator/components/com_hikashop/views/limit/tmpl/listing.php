...
<form action="index.php?option=<?php echo HIKASHOP_COMPONENT ?>&amp;ctrl=limit" method="post"  name="adminForm" id="adminForm">
	<table>
		<tr>
			<td width="100%">
			...
			<td nowrap="nowrap">
				<?php echo $this->limit_type->display('limit_type',$this->pageInfo->filter->limit_type); ?>
			</td>
		</tr>
	</table>
